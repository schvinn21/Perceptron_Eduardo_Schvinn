...
def funcao_de_ativacao(produto_x_pesos):
    if produto_x_pesos > bias :
        return 1
    else :
        return 0
...
mean1 = [2, 6] ; cov1 = [[0.5, 0.2], [0.2, 0.5]]

mean2 = [6, 2] ; cov2 = [[0.5, 0.2], [0.2, 0.5]]
...
Apartir daqui serão gerados novos dados afim de testar os treinamentos feitos anteriormente.



'''

#Primeiro teste, utilizando dados similares. Porém outra semente
'''
mean1_teste = [2, 6] ; cov1_teste = [[0.5, 0.2], [0.2, 0.5]]

mean2_teste = [6, 2] ; cov2_teste = [[0.5, 0.2], [0.2, 0.5]]

seed_teste = 15
'''

mean1_teste = [2, 2] ; cov1_teste = [[0.5, 0.2], [0.2, 0.5]]

mean2_teste = [8, 8] ; cov2_teste = [[0.5, 0.2], [0.2, 0.5]]

seed_teste = 15


#Segundo teste Utilizando dados diferentes
